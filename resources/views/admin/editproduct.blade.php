          ...
          <div class="col-md-12">
            ...
            <div class='alert alert-success'>
             {{   Session::get('status');}}
              ...
              <!-- form start -->
                {{--  <form id="quickForm"> --}}
              {!!Form::open(['action' => 'App\Http\Controllers\ProductController@updateproduct', 'method' => 'POST','class'=>'form-group',
              ...
              {{ csrf_field() }}
               ...
               <div class="form-group">
                    ...
                    {{Form::text('product_name', $product->product_name, ['class' => 'form-control', 'placeholder' => 'Enter product name','id'=>'exampleInputEmail1'])}}
                  ...
                  <div class="form-group">
                    ...
                    {{Form::text('product_price',$product->product_price, ['class' => 'form-control', 'placeholder' => 'Enter product price','id'=>'exampleInputEmail1', 'min'=>'1'])}}
