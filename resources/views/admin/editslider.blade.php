        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <!-- form start -->
             {{-- <form >--}}
                {!!Form::open(['action' => 'App\Http\Controllers\SliderController@updateslider', 'method' => 'POST','class'=>'form-group',
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    {{Form::text('description1', $slider->description1, ['class' => 'form-control', 'placeholder' => 'Enter slider description','id'=>'exampleInputEmail1'])}}
                  ...
                  <div class="form-group">
                   {{-- <label for="exampleInputEmail1">Slider description 2</label>--}} 
                    ...
                    {{Form::text('description2', $slider->description2, ['class' => 'form-control', 'placeholder' => 'Enter slider description','id'=>'exampleInputEmail1'])}}
