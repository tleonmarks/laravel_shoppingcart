    ...
    public function  create_account(Request $request){
       ...
       public function access_account(Request $request){
        ...
        if($client){
         ...
         return back()->with('status', 'You dont have an Account');
       }
...
public function payment_success(Request $request){
    try{
       ...
       // return redirect('/cart')->with('status', 'Your Payment has been Successfully completed!!');
      ...
      Session::forget('cart') ;
      return redirect('/cart')->with('status', 'puchase completted successfully');
